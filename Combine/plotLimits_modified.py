...
# legend = plot.PositionedLegend(0.4, 0.15, 1, 0.015, horizontaloffset=0.3)
legend = ROOT.TLegend(0.45, 0.72, 0.9, 0.89)
...
axis = None
defcols = [
    ROOT.TColor.GetColor("#367E18"), ROOT.TColor.GetColor("#DF2E38"), ROOT.kBlue, ROOT.kBlack, ROOT.kYellow+2,
...
axis[0].GetYaxis().SetTitleOffset(0.1)
# axis[0].GetYaxis().SetRangeUser(0, 10)
axis[0].GetXaxis().SetTitle(args.x_title)
axis[0].GetXaxis().SetLabelOffset(axis[0].GetXaxis().GetLabelOffset()*2.5)
axis[0].GetYaxis().SetTitleOffset(1)
...
plot.DrawCMSLogo(pads[0], 'CMS', args.cms_sub, 10, 0.045, 0.035, 1.2, '', 0.8)
plot.DrawTitle(pads[0], args.title_right, 3)
plot.DrawTitle(pads[0], args.title_left, 1)

canv.Print('resolved_merged.pdf')
canv.Print('resolved_merged.png')

...
def get_options():
  ...
  parser.add_option("--sigScaler", dest="sigScaler",  default=10, type='int', help="scale signal histogram (for visualization)")
  parser.add_option("--channelText", dest="channelText",  default="", type=str, help="decay channel (for visualization)")
